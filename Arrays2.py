...
print("-----------------------------------------------   STEP THREE  -----------------------------------------------")
step3array = salesArray >= 100
print()

## Step 4: Print the total sales for each register.
print("-----------------------------------------------   STEP FOUR   -----------------------------------------------")
step4array = np.sum(salesArray, axis = 1)
print(step4array)
print()
...
print("-----------------------------------------------   STEP FIVE  -----------------------------------------------")
step5array = salesArray * .02
print(step5array)
step5fees = np.sum(step5array)
print(step5fees)
print()
